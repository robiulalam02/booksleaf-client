                ...
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        ...
                        <div className="mt-6 lg:max-w-sm">
                            <p className="text-sm text-gray-800">
                                BooksLeaf is a modern online bookshelf where you can collect, organize, and track your favorite books.
                            </p>
                            <p className="mt-4 text-sm text-gray-800">
                                save quotes and notes, set reading goals, and keep your entire reading journey beautifully managed in one place.
                            </p>
                        </div>
                    </div>
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex">
                            ...
                            <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">info@booksleaf.com</a>
                        </div>
                        <div className="flex">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-sm text-gray-500">
                            Stay updated, get reading tips, and join the community!
                        </p>
                    </div>
                </div>
                <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                    <p className="text-sm text-gray-600">
                        © Copyright 2025 BooksLeaf. All rights reserved.
                    </p>
