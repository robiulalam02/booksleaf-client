    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-center justify-evenly lg:justify-between h-full'>
            <div className='w-full lg:w-6/12 text-center lg:text-start px-4 lg:px-0'>
                ...
                <p className='mt-5 pr-0 lg:pr-10'>Share your personal collection or self-published works. Build a virtual bookshelf that others can explore and appreciate.</p>
            </div>
            <div className='w-full md:w-10/12 lg:w-6/12 flex justify-center items px-4 lg:px-0'>
