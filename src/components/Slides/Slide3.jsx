    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-center justify-evenly lg:justify-between h-full'>
            <div className='w-full lg:w-6/12 text-center lg:text-start px-4 lg:px-0'>
                ...
                <p className='mt-5 pr-0 lg:pr-10'>Express your thoughts, review books you've read, and help others discover stories worth exploring — your words can inspire fellow readers.</p>
            </div>
            <div className='sm:w-10/12 lg:w-6/12 flex justify-center items'>
