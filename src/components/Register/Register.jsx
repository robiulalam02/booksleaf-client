        ...
        userRegister(email, password)
            .then(result => {
                if (result.user) {
                    ...
                    axios.post('https://books-leaf-server.vercel.app/users', userData)
                        .then(res => {
                ...
                <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
                    ...
                    <form onSubmit={handleRegister}>
                        <div className="space-y-4">
                            <div>
                                <label for="email" className="block text-sm font-medium text-gray-700 mb-1">Name</label>
                            ...
                            <div>
                                <label for="email" className="block text-sm font-medium text-gray-700 mb-1">Photo URL</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div className="flex items-center">
                                ...
                                <label for="remember_me" className="ml-2 block text-sm text-gray-700">I accept the <span className='text-blue-600'>terms</span> & <span className='text-blue-600'>condition</span></label>
                            </div>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <button onClick={() => navigate('/auth/login')} className="font-medium text-blue-600 hover:text-blue-500">Sign In</button>
                        </p>
                    </div>
                </div>
